                ...
                <div className="mx-auto w-full max-w-lg">
                    <DrawerHeader className="text-center">
                        ...
                        <div className={cn(
                            ...
                            mode === 'adjustment' ? 'bg-primary/10' : 'bg-success/10'
                        )}>
                            {mode === 'adjustment' 
                    ...
                    {mode === 'adjustment' ? (
                        ...
                        <div className="px-6 space-y-4 py-4">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                ...
                                <div className="text-center min-w-[100px]">
                                    <p className="text-4xl font-bold text-success">{purchaseQty}</p>
                                    <p className="text-sm text-muted-foreground">{packUnit}</p>
                                </div>
                                <button
                                    type="button"
                            ...
                            <div className="p-4 bg-success/10 rounded-xl">
                                ...
                                <p className="text-2xl font-bold text-success">{formatRupiah(totalPurchase)}</p>
                            </div>
                    ...
                    <DrawerFooter className="py-4 pb-8 border-t border-border">
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                onMouseDown={createRippleEffect}
                                className={cn(
                                    'flex-1 px-6 py-3.5 rounded-xl font-medium ripple',
                                    mode === 'adjustment' 
