        ...
        <div className="min-h-screen bg-primary">
            ...
            <div className="relative z-10 bg-background rounded-t-3xl px-4 pt-6 pb-24 min-h-[80dvh] shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.05)]">
                ...
                <div className={cn(
                    ...
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className={cn(
                            ...
                            grossProfit >= 0 ? 'bg-success/20 text-success' : 'bg-destructive/20 text-destructive'
                        )}>
                    ...
                    <p className={cn(
                        ...
                        {grossProfit < 0 && '-'}{formatRupiah(Math.abs(grossProfit))}
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="bg-muted/30 rounded-2xl p-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[11px] text-muted-foreground">Penjualan</span>
                        </div>
                    ...
                    <div className="bg-muted/30 rounded-2xl p-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[11px] text-muted-foreground">Pembelian</span>
                        </div>
                        <p className="text-base font-bold text-foreground">{formatRupiah(totalPurchases)}</p>
                    </div>
                    <div className="bg-muted/30 rounded-2xl p-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[11px] text-muted-foreground">Piutang Baru</span>
                        </div>
                        <p className="text-base font-bold text-foreground">{formatRupiah(totalDebtAdded)}</p>
                    </div>
                    <div className="bg-muted/30 rounded-2xl p-4">
                        <div className="flex items-center gap-2 mb-2">
                            <div className="p-1.5 bg-success/10 rounded-lg">
                            ...
                            <span className="text-[11px] text-muted-foreground">Piutang Bayar</span>
                        </div>
                        <p className="text-base font-bold text-foreground">{formatRupiah(totalDebtPaid)}</p>
                    </div>
                </div>
                ...
                <div className="bg-muted/30 rounded-2xl p-4 flex items-center justify-between mb-6">
                    ...
                    <span className="text-xl font-bold text-foreground">{transactionCount}</span>
                </div>
                ...
                <div className="bg-muted/30 rounded-2xl p-4 mb-6">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="text-sm font-bold text-foreground">Penjualan 7 Hari</h3>
                    </div>
                    <div className="h-40">
                            ...
                            {topItems.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-[11px] text-muted-foreground">{item.quantity}x terjual</p>
                                    </div>
                                    <p className="text-sm font-bold text-foreground">{formatRupiah(item.total)}</p>
                                </div>
                            ))}
                        </div>
                    )}
