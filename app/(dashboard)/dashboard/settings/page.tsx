...
import { ArrowLeft, Store, Coffee, ShoppingBag, UtensilsCrossed, Building2, Sun, Moon, Monitor, User, Palette, Info, Check, Camera } from 'lucide-react';
...
export default function SettingsPage() {
    ...
    const { storeName, ownerName, profileImage, appIcon, setStoreName, setOwnerName, setProfileImage, setAppIcon } = useUserStore();
                    ...
                    <div className="bg-card rounded-2xl p-4 space-y-4 shadow-sm border">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-muted-foreground">{localOwnerName || 'Belum diatur'}</p>
                            </div>
                        </div>
                ...
                <section id="about" className="space-y-4">
                    ...
                    <div className="bg-card rounded-2xl p-4 space-y-3 shadow-sm border">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm text-muted-foreground">Tim Katalis AI</span>
                        </div>
                        <Separator />
                        <div className="pt-2">
